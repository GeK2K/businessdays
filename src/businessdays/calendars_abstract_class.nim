...
# ===================     bdCalendar  (abstract class)     =================== #

type
  bdCalendar* {.inheritable.} = ref object
    ## In our computer modeling, calendars are objects of this type.


method  `$`*(calendar: bdCalendar): string  {.base.} =
...
method  nextbday*(calendar: bdCalendar, dt: DateTime, forward = true, 
...
method  bdays*(calendar: bdCalendar; fromDate, toDate: DateTime; 
...
method  addbdays*(calendar: bdCalendar, dt: DateTime, nbdays: int64, 
...
method  observedHolidays*(calendar: bdCalendar; year: int, month: Month): seq[DateTime] {.base.} = 
  ...
  **See also:**
    - `observedHolidays <calendars.html#observedHolidays.e%2CbdCalendar%2CDateTime%2CDateTime>`_
  ]##
...
method  observedHolidays*(calendar: bdCalendar; year: int): 
                         seq[DateTime] {.base.} = 
  ##[
