...
import  std/[math, options], questionable
export  options, questionable


# ===============================     Proc     =============================== #

func  gregorianEasterSundayMMDD*(year: int): ?tuple[month: int, monthday: int] =
  ##[
  **Returns:**
  ...
  **Notes:**
  ...
  runnableExamples:
    ...
    doAssert:  !gregorianEasterSundayMMDD(2000) == (month: 4, monthday: 23)
    doAssert:  !gregorianEasterSundayMMDD(2018) == (month: 4, monthday: 1) 
    doAssert:  !gregorianEasterSundayMMDD(2036) == (month: 4, monthday: 13)
    doAssert:  !gregorianEasterSundayMMDD(2054) == (month: 3, monthday: 29)
    doAssert:  !gregorianEasterSundayMMDD(2071) == (month: 4, monthday: 19) 
    doAssert:  !gregorianEasterSundayMMDD(2097) == (month: 3, monthday: 31)
